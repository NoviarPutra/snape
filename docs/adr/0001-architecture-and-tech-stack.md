...
- **LLM & Embeddings**: Google Gemini Flash API (`gemini-2.0-flash`) for low-latency token generation + `text-embedding-004` (768 dimensions) for semantic memory storage.
